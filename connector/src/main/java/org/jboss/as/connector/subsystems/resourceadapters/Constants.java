...
public class Constants {
    ...
    static final SimpleAttributeDefinition FROM = new SimpleAttributeDefinitionBuilder(FROM_NAME, ModelType.STRING)
            .setAllowExpression(true)
            .setAllowNull(true)
            .setXmlName(WorkManagerSecurity.Attribute.FROM.getLocalName())
            .build();

    static final SimpleAttributeDefinition TO = new SimpleAttributeDefinitionBuilder(TO_NAME, ModelType.STRING)
            .setAllowExpression(true)
            .setAllowNull(true)
            .setXmlName(WorkManagerSecurity.Attribute.TO.getLocalName())
            .build();

    static final ObjectTypeAttributeDefinition WM_SECURITY_MAPPING_GROUP = ObjectTypeAttributeDefinition.Builder.of(WM_SECURITY_MAPPING_GROUP_NAME, FROM, TO).build();
    ...
    static final ObjectTypeAttributeDefinition WM_SECURITY_MAPPING_USER = ObjectTypeAttributeDefinition.Builder.of(WM_SECURITY_MAPPING_USER_NAME, FROM, TO).build();
