...
public class XaDataSourceService extends AbstractDataSourceService {
    ...
    // createManagedConnectionFactory(final String jndiName,
    // final Driver driver) throws ResourceException, StartException {
    // final XAManagedConnectionFactory xaManagedConnectionFactory = new
    ...
    // } catch (Exception e) {
    // throw new StartException("Failed to load XA DataSource class - " +
    // dataSourceConfig.getXaDataSourceClass());
    // }
    //
    ...
    // return createPoolConfiguration(dataSourceConfig.getXaPool(),
    // dataSourceConfig.getTimeOut(),
    // dataSourceConfig.getValidation());
    // }
    //
    // protected Pool createPool(final String jndiName, final
    // ManagedConnectionFactory mcf, PoolConfiguration pc) {
    //
    // Boolean noTxSeparatePool = Boolean.FALSE;
    //
    // if (dataSourceConfig.getXaPool() != null &&
    // dataSourceConfig.getXaPool().isNoTxSeparatePool() != null) {
    // noTxSeparatePool = dataSourceConfig.getXaPool().isNoTxSeparatePool();
    // }
    //
    // final PoolFactory pf = new PoolFactory();
    // final Pool pool = pf.create(PoolStrategy.ONE_POOL, mcf, pc,
    ...
    // }
    //
    // protected ConnectionManager createConnectionManager(final String
    // jndiName, final Pool pool) {
    ...
    // dataSourceConfig.getTimeOut().getAllocationRetryWaitMillis();
    ...
    // }
    //
    // String securityDomain = dataSourceConfig.getSecurity() != null ?
    // dataSourceConfig.getSecurity().getSecurityDomain()
    // : null;
    // // Select the correct connection manager
    // TransactionSupport.TransactionSupportLevel tsl =
    // TransactionSupport.TransactionSupportLevel.XATransaction;
    // ConnectionManagerFactory cmf = new ConnectionManagerFactory();
    // ConnectionManager cm = cmf.createTransactional(tsl, pool, null,
    // securityDomain, allocationRetry,
    // allocationRetryWaitMillis, getTransactionIntegration(), interleaving,
