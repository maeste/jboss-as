...
public class DistributedResourceAdapter1 implements ResourceAdapter {
    ...
    private static final Logger log = Logger.getLogger(DistributedResourceAdapter1.class.getCanonicalName());
    ...
    public void setDwm(NamedDistributedWorkManager dwm) {
        log.info("Setting workmanager: " + dwm.getClass().getCanonicalName());
        this.dwm = dwm;
    }
    ...
    public void start(BootstrapContext ctx) throws ResourceAdapterInternalException {
        ...
        log.debug("Workmanager class: " + wm.getClass().getCanonicalName());
