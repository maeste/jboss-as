...
public class BootstrapContextAdd extends AbstractAddStepHandler {
    ...
    protected void populateModel(final ModelNode operation, final ModelNode model) throws OperationFailedException {
        for (AttributeDefinition parameter : JcaBootstrapContextDefinition.ATTRIBUTES) {
    ...
    protected void performRuntime(final OperationContext context, final ModelNode operation, final ModelNode model) throws OperationFailedException {
        ...
        String workmanager = JcaBootstrapContextDefinition.WORKMANAGER.resolveModelAttribute(context, model).asString();
