...
public abstract class AbstractDwmTestCase {
    ...
    protected void logWorkStats() {
        ...
        log.info("doWorkAccepted (server 1, distributed): " + server1Proxy.getDistributedDoWorkAccepted());
        log.info("doWorkAccepted (server 2, distributed): " + server2Proxy.getDistributedDoWorkAccepted());
        ...
        log.info("doWorkRejected (server 1, distributed): " + server1Proxy.getDistributedDoWorkRejected());
        log.info("doWorkRejected (server 2, distributed): " + server2Proxy.getDistributedDoWorkRejected());
        ...
        log.info("startWorkAccepted (server 1, distributed): " + server1Proxy.getDistributedStartWorkAccepted());
        log.info("startWorkAccepted (server 2, distributed): " + server2Proxy.getDistributedStartWorkAccepted());
        ...
        log.info("startWorkRejected (server 1, distributed): " + server1Proxy.getDistributedStartWorkRejected());
        log.info("startWorkRejected (server 2, distributed): " + server2Proxy.getDistributedStartWorkRejected());
        ...
        log.info("scheduleWorkAccepted (server 1, distributed): " + server1Proxy.getDistributedScheduleWorkAccepted());
        log.info("scheduleWorkAccepted (server 2, distributed): " + server2Proxy.getDistributedScheduleWorkAccepted());
        ...
        log.info("scheduleWorkRejected (server 1, distributed): " + server1Proxy.getDistributedScheduleWorkRejected());
        log.info("scheduleWorkRejected (server 2, distributed): " + server2Proxy.getDistributedScheduleWorkRejected());
    }
}
