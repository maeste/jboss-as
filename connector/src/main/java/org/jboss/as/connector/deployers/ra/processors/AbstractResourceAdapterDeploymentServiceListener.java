                            ...
                            if ((wm != null && wm.getStatistics() != null) || poolStats.getNames().size() != 0) {
                                ...
                                synchronized (this) {
                                    ...
                                    try {
                                        ...
                                        raRegistration = statsRegistration.getSubModel(PathAddress.pathAddress(peStats));
                                    }
                                    Resource raResource;

                                    if (!statisticsResource.hasChild(peStats)) {
                                    ...
                                    if (wm.getStatistics() != null) {
                                        if (wm instanceof DistributedWorkManager && ((DistributedWorkManager)wm).getDistributedStatistics() != null ) {
