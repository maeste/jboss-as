...
public class DwmTest {
    ...
    private static final ModelNode DEFAULT_DWM_STATS_ADDRESS = new ModelNode()
            .add(SUBSYSTEM, "jca")
            .add("distributed-workmanager", DEFAULT_DWM_NAME)
            .add("statistics","distributed");
    ...
    private static final int SRT_MAX_THREADS = 1;
    private static final int SRT_QUEUE_LENGTH = 1;
    ...
    public void testScheduleWork() throws IOException, NamingException, WorkException, InterruptedException {
        ...
        long startTime = System.currentTimeMillis();
        int schedulWorkAccepted = server1Proxy.getDistributedScheduleWorkAccepted();
        ...
        Assert.assertTrue("Expected scheduleWorkAccepted = " + (schedulWorkAccepted + SRT_MAX_THREADS + 1) + " but was: " + server1Proxy.getDistributedScheduleWorkAccepted(),
                server1Proxy.getDistributedScheduleWorkAccepted() == schedulWorkAccepted + SRT_MAX_THREADS + 1);
    }
