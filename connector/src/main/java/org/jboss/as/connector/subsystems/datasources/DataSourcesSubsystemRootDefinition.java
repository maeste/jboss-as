 ...
 */
public class DataSourcesSubsystemRootDefinition extends PersistentResourceDefinition {
    ...
    public List<? extends PersistentResourceDefinition> getChildren() {
        if (!deployed) {
            PersistentResourceDefinition[] CHILDREN = {
                    DataSourceDefinition.createInstance(registerRuntimeOnly, deployed),
                    XaDataSourceDefinition.createInstance(registerRuntimeOnly, deployed),
                    JdbcDriverDefinition.INSTANCE
            };
