...
import static org.jboss.as.connector.subsystems.resourceadapters.Constants.FROM;
...
import static org.jboss.as.connector.subsystems.resourceadapters.Constants.TO;
...
public class RaOperationUtil {
    ...
    public static ModifiableResourceAdapter buildResourceAdaptersObject(final String id, final OperationContext context, ModelNode operation, String archiveOrModule) throws OperationFailedException {
        ...
        if (wmSecurity) {
            ...
            final Map<String, String> groups = ModelNodeUtil.extractMap(operation, WM_SECURITY_MAPPING_GROUPS, FROM, TO);
            final Map<String, String> users = ModelNodeUtil.extractMap(operation, WM_SECURITY_MAPPING_USERS, FROM, TO);
